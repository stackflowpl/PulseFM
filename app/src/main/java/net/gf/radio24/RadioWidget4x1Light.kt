...
class RadioWidget4x1Light : AppWidgetProvider() {
    ...
    companion object {
        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            val views = RemoteViews(context.packageName, R.layout.widget_4x1_light)
            ...
            val trackInfo = sharedPrefs.getString("trackInfo", "Na żywo") ?: "Na żywo"
